sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/corp/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.corp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/corp/localService/mockserver"], function (mockserver) {
