	...
	return BaseController.extend("com.corp.controller.Master", {
		...
		onStartPress: function() {
			if (!this._oStartDialog) {
				this._oStartDialog = sap.ui.xmlfragment("com.corp.view.StartDialog", this);
		...
		onChartPress: function() {
			this.getRouter().navTo("chart", true);
		},
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("com.corp.view.ViewSettingsDialog", this);
